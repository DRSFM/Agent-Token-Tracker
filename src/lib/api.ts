...
export const api: TokenAPI = {
  ...
  getCloudSyncSettings: wrap('getCloudSyncSettings'),
  setCloudSyncSettings: wrap('setCloudSyncSettings'),
  getCloudAuthStatus: wrap('getCloudAuthStatus'),
  requestCloudEmailOtp: wrap('requestCloudEmailOtp'),
  verifyCloudEmailOtp: wrap('verifyCloudEmailOtp'),
  startCloudOAuth: wrap('startCloudOAuth'),
  completeCloudOAuth: wrap('completeCloudOAuth'),
  signOutCloud: wrap('signOutCloud'),
  getCloudSyncStatus: wrap('getCloudSyncStatus'),
  syncCloudNow: wrap('syncCloudNow'),
  getCloudUsageSummary: wrap('getCloudUsageSummary'),
  ...
  getCodexRateLimitResetCredits: wrap('getCodexRateLimitResetCredits'),
  getGrokUsageStatus: wrap('getGrokUsageStatus'),
  ...
  openCodexCredentialFolder: wrap('openCodexCredentialFolder'),
  launchCodexWithCredential: wrap('launchCodexWithCredential'),
  exportCodexCredential: wrap('exportCodexCredential'),
  deleteCodexCredential: wrap('deleteCodexCredential'),
  startCodexOAuthLogin: wrap('startCodexOAuthLogin'),
  submitCodexOAuthCallbackUrl: wrap('submitCodexOAuthCallbackUrl'),
  completeCodexOAuthLogin: wrap('completeCodexOAuthLogin'),
  importCodexCredentialText: wrap('importCodexCredentialText'),
  importCodexApiKey: wrap('importCodexApiKey'),
  importCurrentCodexAuth: wrap('importCurrentCodexAuth'),
  importCodexCredentialFiles: wrap('importCodexCredentialFiles'),
