...
const recentRequests: RequestRecord[] = [
  ...
  {
    id: 'r6',
    timestamp: new Date(today.setHours(13, 18, 29)).toISOString(),
    source: 'codex',
    usageChannel: 'api',
    upstream: { id: 'anyrouter', label: 'AnyRouter', baseUrl: 'https://anyrouter.example/v1' },
    sessionId: 'api-s1',
    sessionTitle: 'AnyRouter API 调试',
    model: 'gpt-4.1',
    inputTokens: 2_100,
    outputTokens: 1_280,
    cacheTokens: 640,
    rawTotalTokens: 4_020,
    weightedTotalTokens: 3_444,
    totalTokens: 3_444,
  },
  {
    id: 'r7',
    timestamp: new Date(today.setHours(12, 56, 11)).toISOString(),
    source: 'codex',
    usageChannel: 'api',
    upstream: { id: 'muyuanpub', label: 'muyuanpub', baseUrl: 'https://muyuanpub.example/v1' },
    sessionId: 'api-s2',
    sessionTitle: 'muyuanpub API 会话',
    model: 'gpt-4o',
    inputTokens: 1_840,
    outputTokens: 920,
    cacheTokens: 380,
    rawTotalTokens: 3_140,
    weightedTotalTokens: 2_798,
    totalTokens: 2_798,
  },
]
...
const dataSourceStatus: DataSourceStatus = {
  ...
  sources: [
    ...
    },
    {
      ...
      usageChannel: 'api',
      upstream: { id: 'muyuanpub', label: 'muyuanpub', baseUrl: 'https://muyuanpub.example/v1' },
      rootPath: '~/.codex-api/profiles/muyuanpub/sessions',
      rootExists: true,
      healthy: true,
      scannedFiles: 1,
      parsedFiles: 1,
...
export const mockAPI: TokenAPI = {
  ...
  async getGrokUsageStatus() {
    return {
      ...
      weeklyRemainingPercent: 87.5,
      weeklyResetsAt: new Date(Date.now() + 3 * 24 * 60 * 60 * 1000).toISOString(),
      sessionCount: 3,
      totalTokens: 78_715,
